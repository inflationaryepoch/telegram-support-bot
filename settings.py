...
WELCOME_MESSAGE = os.getenv("WELCOME_MESSAGE", "İşler iletişime hoş geldin {mention} , buraya bize iletmek istediklerinizi yazabilirsiniz. En kısa sürede dönüş yapılacaktır.")
